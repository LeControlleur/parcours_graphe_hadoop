...
public class ParcoursGraphesOutputFormat extends FileOutputFormat<Text, GraphNodeWritable> {
  ...
  // dire une instance de notre classe GraphRecordWriter.
    ...
    Path fullPath = new Path(path, FileOutputFormat.getUniqueFile(context, "part", ".txt"));
    ...
    return new ParcoursGraphesRecordWriter(fileOut);
	}
}
